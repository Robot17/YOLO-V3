...
class YOLO(object):
    _defaults = {
        ...
        "anchors_path": 'dataset/anchors.txt',
        "classes_path": 'dataset/classes.txt',
        "score" : 0.25,
        "iou" : 0.4,
        "model_image_size" : (416, 416),
        "gpu_num" : 1,
        "test_path":'dataset/my_test.txt'
    }
    ...
    def detect_image(self, image,image_name):
        start = timer()
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            data_line=image_name+','+str(left)+','+str(top)+','+str(right)+','+str(bottom)
            write_line(self.test_path,data_line)
